...
7-) Const-Permanent sabit değişkenler BÜYÜK_HARFLERLE_YAZINIZ.
8-) Değişkenlerde global değişken varsa  `global` keyword yazınız ancak bu  önerilmez.
9-) string için çift veya tek tırnak kullanamabilirsiniz.
  
kebap-case,  camelCase, PascalCase, snake_case  
